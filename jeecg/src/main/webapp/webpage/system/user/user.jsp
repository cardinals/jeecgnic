    ...
    <table style="width: 600px;" cellpadding="0" cellspacing="1" class="formtable">
            ...
            <td class="value" width="85%">
                ...
                <c:if test="${user.id==null }">
                    <input id="userName" class="inputxt" name="userName" validType="t_s_base_user,userName,id"
                           value="${user.userName }" maxlength="50" datatype="s2-50"/>
        ...
        <tr>
            ...
            <td class="value" width="10%">
                <input id="realName" class="inputxt" name="realName" value="${user.realName }" maxlength="25"
                       datatype="s2-25"/>
        ...
        <tr>
            ...
            <td class="value">
                ...
                <t:dictSelect field="orgIds" type="list" datatype="*"
                              dictTable="t_s_depart" dictField="id" dictText="departname" defaultVal="${orgIds}"
                              hasLabel="false" title="部门"></t:dictSelect>
        ...
        <tr>
            ...
            <td class="value" nowrap>
                ...
                <t:choose hiddenName="roleid" hiddenid="id" textname="roleName" url="userController.do?roles"
                          name="roleList" icon="icon-search" title="common.role.list" isclear="true"
