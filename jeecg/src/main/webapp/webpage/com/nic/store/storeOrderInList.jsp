...
<div class="easyui-layout" fit="true">
    <div region="center" style="padding:0px;border:0px">
        <t:datagrid name="storeOrderInList" checkbox="true" fitColumns="true" title="入库单列表"
                    actionUrl="storeOrderController.do?datagrid&orderType=0" idField="id" fit="true" queryMode="group">
            ...
            <t:dgToolBar title="录入" icon="icon-add" url="storeOrderController.do?storeOrderInPage" funname="add"
                         height="350"></t:dgToolBar>
            <%--<t:dgToolBar title="编辑" icon="icon-edit" url="storeOrderController.do?addorupdate" funname="update"
                         height="350"></t:dgToolBar>--%>
            <t:dgToolBar title="查看" icon="icon-search" url="storeOrderController.do?storeOrderInPage" funname="detail"
                         height="350"></t:dgToolBar>
